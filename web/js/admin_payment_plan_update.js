...
var id;
    $("#update_paymentplan_btn").click(function() {
            ...
            function(courses) {
                ...
                else
                {
                    $.each(courses, function(key, value) {
                        $("#course_pay").append('<h3><input type="radio" name="course" value='+ value.planid + '>' + value.name + '</input></h3>\n\<p>' 
...
{
    $.post("/instructor/paymentplan/update", {
        plan_id: id,
        ...
        if (data[0] === "success")
        {
            alert("payment plan successfully updated");
            window.location.href = '/instructor/update/paymentplan';
        }
        else
        {
